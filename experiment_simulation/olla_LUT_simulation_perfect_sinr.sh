...
#SBATCH -o slurm_message/outputs/olla_LUT_simulation.out
#SBATCH -e slurm_message/errors/olla_LUT_sumulation.err
...
srun --ntasks=1 python3 olla_LUT_simulation_perfect_sinr.py
wait
